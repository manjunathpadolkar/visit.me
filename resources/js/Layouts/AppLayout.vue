                                    ...
                                    <template #trigger>
                                        <span  class="inline-flex rounded-md relative">
                                            <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition">
                                                ...
                                                <span class=" rounded-full bg-red-600 px-1 text-white text-xs absolute top-1 right-0" v-if="$store.state.notifications.length > 0">{{  $store.state.notifications.length  }}</span>
                                            </button>
                                        </span>
                                    </template>
